					...
					<div class="panel-body">
						...
						<form action="" method="POST" id="loginForm">
							<div class="form-group">
								...
								<input type="text" placeholder="Nama" title="Silahkan Masukan Nama" value="<?php echo set_value('nama'); ?>" name="nama" id="Nama" class="form-control" autocomplete="off" autofocus>
								<?php echo form_error('nama', '<span class="help-block small text-danger">', '</span>'); ?>
							</div>
							<div class="form-group">
								<label class="control-label" for="username">Username</label>
								<input type="text" placeholder="Username" title="Silahkan Masukan Username" value="<?php echo set_value('username'); ?>" name="username" id="username" class="form-control" autocomplete="off">
								<?php echo form_error('username', '<span class="help-block small text-danger">', '</span>'); ?>
							</div>
							<div class="form-group">
								<label class="control-label" for="password">Password</label>
								<input type="password" name="password" title="Silahkan Masukan Password" placeholder="Password" id="password" class="form-control">
								<?php echo form_error('password', '<span class="help-block small text-danger">', '</span>'); ?>
							</div>
							<div class="form-group">
								<label class="control-label" for="password1">Konfirmasi Password</label>
								<input type="password" name="password1" title="Konfirmasi password" placeholder="Konfirmasi Password" id="password" class="form-control">
								<?php echo form_error('password1', '<span class="help-block small text-danger">', '</span>'); ?>
							</div>
							<button type="submit" class="btn btn-success btn-block loginbtn"><i class="fa fa-plus"></i> Daftar</button>
							<a class="btn btn-default btn-block" href="<?php echo base_url(); ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
						</form>
					</div>
				</div>
			</div>
