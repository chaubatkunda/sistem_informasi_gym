										...
										<form action="" method="post">
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-md-2">
														<input type="text" name="idfasilitas" class="form-control" value="<?php echo $this->fungsi->idFasilitas(); ?>" readonly />
													</div>
												</div>
											</div>
											<div class="form-group-inner">
														...
														<div class="col-lg-9">
															<div class="login-horizental cancel-wp pull-left form-bc-ele">
																<button class="btn btn-custon-three btn-primary" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i>
																	Simpan</button>
																<a href="<?php echo base_url('fasilitas'); ?>" class="btn btn-custon-three
