    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="logo-pro">
                    <a href="<?php echo base_url('user'); ?>"><img class="main-logo" src="<?php echo base_url('public/assets/'); ?>icon/logogymmobile.png" /></a>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                    <li>
                                                        <a href="<?php echo base_url('myprofile'); ?>">
                                                            <span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile
                                                        </a>
                                                    </li>
                                                    <li>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcome-list">
                            <?php if ($this->fungsi->user_login()['level'] == 3) : ?>
                                <a href="<?php echo base_url('daftar'); ?>" class="btn btn-primary">Daftar Sebagai Member</a>
                            <?php endif; ?>
