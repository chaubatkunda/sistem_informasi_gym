...
<head>
  ...
  <title>Egy Gym | <?php echo $title; ?></title>
  ...
  <!-- modals CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/modals.css">

  <!-- select2 CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/select2/select2.min.css">

  <!-- chosen CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/chosen/bootstrap-chosen.css">
  <!-- buttons CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/buttons.css">
  ...
  <!-- notifications CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/notifications/Lobibox.min.css">
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/notifications/notifications.css">



  <!-- style CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/alerts.css">
  <!-- tabs CSS
		============================================ -->
  ...
  <!-- touchspin CSS
		============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('public/assets/'); ?>css/touchspin/jquery.bootstrap-touchspin.min.css">

  <!-- Datatable
		============================================ -->

  <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/assets/datatables/'); ?>DataTables-1.10.20/css/dataTables.bootstrap.css" />
