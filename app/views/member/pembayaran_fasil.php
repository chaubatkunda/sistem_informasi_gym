<div class="container-fluid">
    <div class="row">
        <form action="<?php echo base_url('admin/save_confirm_fasilitas'); ?>" method="post" enctype="multipart/form-data">
            <div class="col-md-2"></div>
            <div class="col-md-8">
                <div class="sparkline10-list">
                    <h2 class="text-center text-primary">Konfirmasi Pembayaran
                        <?php if ($transfas->is_success == 1) : ?>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    <div class="bt-df-checkbox pull-left">
                                        ...
                                        <input type="hidden" name="kodep" value="<?php echo $transfas->kode_pembelian; ?>">
                                    </div>
                                </div>
                            </div>
