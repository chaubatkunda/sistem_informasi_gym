										...
										<form action="" method="post">
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														...
														<input type="hidden" name="id_paket" class="form-control" placeholder="Paket" value="<?php echo $paket['id_paket']; ?>" readonly />
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<select name="senam" class="chosen-select" tabindex="-1">
															<option value="">Pilih Senam</option>
															<?php foreach ($senam as $sn) : ?>
																<?php if ($paket['id_senam'] == $sn['id_senam']) : ?>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<input type="text" name="kuota" class="form-control" placeholder="Kuota" value="<?php echo $paket['kuota']; ?>" autocomplete="off" />
											...
											<div class="form-group-inner">
												<div class="row">
													<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
														<label class="login2 pull-right pull-right-pro">Periode</label>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<div class="row">
															<div class="col-md-6">
																<input type="date" name="periode1" class="form-control" value="<?php echo $paket['date1']; ?>" />
															</div>
															<div class="col-md-6">
																<input type="date" name="periode2" class="form-control" value="<?php echo $paket['date2']; ?>" />
															</div>
														</div>
													</div>
												</div>
											...
											<div class="form-group-inner">
												<div class="row">
													<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
														<label class="login2 pull-right pull-right-pro">Jam Latihan</label>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<div class="row">
															<div class="col-md-6">
																<input type="time" name="jam1" class="form-control" value="<?php echo $paket['jam_mulai']; ?>" />
															</div>
															<div class="col-md-6">
																<input type="time" name="jam2" class="form-control" value="<?php echo $paket['jam_selesai']; ?>" />
															</div>
														</div>
													</div>
												</div>
