    ...
    <div class="container-fluid">
        <div class="row">
            <div class="pogoSlider" id="js-main-slider">
                <div class="pogoSlider-slide" style="background-image:url('<?php echo base_url('public/assets/page/'); ?>images/slider-01.jpg');">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                <div class="full">
                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/resume_img.png" alt="#" />
                </div>
            </div>
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/img1.png" alt="#" />
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/img2.png" alt="#" />
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/img3.png" alt="#" />
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/img4.png" alt="#" />
                                </div>
                            </div>
                        </div>
...
<div class="section layout_padding theme_bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text_align_center">
                <div class="full">
                    <img class="img-responsive" src="<?php echo base_url('public/assets/page/'); ?>images/resume_img2.png" alt="#" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="full">
                    <div class="center">
                        <img src="<?php echo base_url('public/assets/page/'); ?>images/icon1.png" alt="#" />
                    </div>
                    <div class="center">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="full">
                    <div class="center">
                        <img src="<?php echo base_url('public/assets/page/'); ?>images/icon2.png" alt="#" />
                    </div>
                    <div class="center">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="full">
                    <div class="center">
                        <img src="<?php echo base_url('public/assets/page/'); ?>images/icon3.png" alt="#" />
                    </div>
                    <div class="center">
