							...
							<table id="table" class="table table-bordered table-hover">
								...
								<tbody>
									...
									foreach ($transaksi as $trans) : ?>
										<tr>
											<td><?php echo $no++; ?></td>
											<td><?php echo date('d-m-Y', strtotime($trans['tgl_transfasilitas'])); ?></td>
											...
											<td><?php echo number_format($trans['total_bayar'], 0, ',', '.'); ?> </td>
											<td>
												<?php
												$ket = $trans['ket_bayar'];
												if ($ket == 1) : ?>
											...
											<td>
												...
												<?php else : ?>
													<a href="<?php echo base_url('validasi-fasilitas/') . $trans['id_transfasilitas']; ?>" class="btn btn-custon-three btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Validasi">
